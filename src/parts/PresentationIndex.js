        ...
        return (
            <div className="hero pd-lr">
                ...
                <div className="indexDescription">
                    ...
                    <p>
                    Me considero un obsesionado con los detalles y creo que es la forma en como algo de verdad toma valor y se diferencia. Te invito a ver algunos de mis proyectos anteriores. <a href="/info">Más Info →</a>
                    </p>
                </div>
                ...
                <figure className="imagePresentation">
                    ...
                    <figcaption>Foto Pre-pandemia por Jean Gutierrez</figcaption>
                </figure>
            </div>
        )
    }
